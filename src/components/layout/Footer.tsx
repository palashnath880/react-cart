  ...
  return (
    <footer className="border-t">
      <div className="container mx-auto px-5 py-12">
          ...
          <div className="max-xl:col-span-1 col-span-3">
            <div className="space-y-4 flex flex-col gap-3">
              ...
              <p className="text-muted-foreground max-w-xs">
                Your trusted online shopping destination with the best deals and
                quality products.
              </p>
        ...
        {/* copyright area */}
        <div className="border-t mt-8 pt-8 flex items-center justify-between max-md:flex-col max-md:gap-4">
          <p className="text-muted-foreground max-md:text-center">
            &copy; {new Date().getFullYear()} ReactCart. All rights reserved.
          </p>
          <div className="flex justify-end gap-2 max-md:justify-center mt-4">
            <Image
              draggable={false}
